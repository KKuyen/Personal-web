...
import styles from './Experience_tab.module.css';
import Summary from '../context/Experience_context';
import Sun from '../context/Earth_context';
...
// Component được hiển thị khi isFirstColor là false
  ...
  <Sun />
        ...
        <p className={styles.nameTag}>"Earth"</p>
